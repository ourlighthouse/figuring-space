...
Extended space is no stranger to this realism of force: interaction at a distance is a way of creating a symbiotic relationship between an inert spatial interval &mdash; a residue of vacuum between things &mdash; and an intensity freely given by the forces of attraction or repulsion. But in this swindle, the force allows itself to be swallowed up in the spatial. Leibniz recognized that it was a single motion that would fluidify space and desubstantiate force: to throw a bridge between space and action, it is necessary to promote the idea of a generalized elasticity that is applicable to things, figures, forces, distances and cutouts of substance by the Understanding.
